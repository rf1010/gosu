...
class Tuple5<T1, T2, T3, T4, T5> implements ITuple {
  ...
  private var e5: T5 as readonly Element5  

  final override property get size(): int { return 5 }

  construct(final elem1: T1, final elem2: T2, final elem3: T3, final elem4: T4, final elem5: T5 ) {
    e1 = elem1
    e2 = elem2
    e3 = elem3
    e4 = elem4
  ...
  static function apply<E1, E2, E3, E4, E5>(final e1: E1, final e2: E2, final e3: E3, final e4: E4, final e5: E5): Tuple5 {
    var params = { e1, e2, e3, e4, e5 }.toArray()
    var className = TypeSystemUtil.getClassNameFromType(Tuple5)
    return TypeSystemUtil.getInstanceByClassName(className, params) as Tuple5
  }
  ...
  override function hashCode(): int {
    ...
    if (result == 0) {
      ...
      result = 31 * result + (e5 == null ? const : e5.hashCode())
      _hashCode = result
    }
    return result
  }
  ...
  override function equals(that: Object): boolean {
    ...
    if (!(that typeis Tuple5)) {
      return false
    }
    return
      
        ((that as Tuple5).e1 typeis T1 or (that as Tuple5).e1 == null) and
        ((that as Tuple5).e2 typeis T2 or (that as Tuple5).e2 == null) and
        ((that as Tuple5).e3 typeis T3 or (that as Tuple5).e3 == null) and
        ((that as Tuple5).e4 typeis T4 or (that as Tuple5).e4 == null) and
        ((that as Tuple5).e5 typeis T5 or (that as Tuple5).e5 == null) and
        (that as Tuple5).e1 == this.e1 and
        (that as Tuple5).e2 == this.e2 and
        (that as Tuple5).e3 == this.e3 and
        (that as Tuple5).e4 == this.e4 and
        (that as Tuple5).e5 == this.e5
      
  }

  override function toString(): String {
    return "Tuple5<${typeof e1}, ${typeof e2}, ${typeof e3}, ${typeof e4}, ${typeof e5}>(${e1}, ${e2}, ${e3}, ${e4}, ${e5})"
  }
}